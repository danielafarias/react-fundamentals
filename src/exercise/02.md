...
- Programação Imperativa: Como você faz
- Programação Declarativa: O que você quer fazer
- React é declarativo
- React transforma a API imperativa do navegador em algo declarativo para ser trabalhado
- ReactDOM: Renderiza elemento do React no DOM
